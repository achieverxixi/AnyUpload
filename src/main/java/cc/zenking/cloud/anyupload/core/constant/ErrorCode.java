...
public class ErrorCode {
    ...
    //修改流程节点失败！
    public static Integer ERROR_CODE_1014 = 1014;
    //查询课题工作台待办事项失败！
    public static Integer ERROR_CODE_1015 = 1015;
    //查询区县失败！
    public static Integer ERROR_CODE_1016 = 1016;
    //查询学校失败！
    public static Integer ERROR_CODE_1017 = 1017;
    //查询机构级别失败!
    public static Integer ERROR_CODE_1018 = 1018;
